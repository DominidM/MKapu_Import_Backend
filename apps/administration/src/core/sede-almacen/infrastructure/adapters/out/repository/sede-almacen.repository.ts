/* ============================================
   administration/src/core/sede-almacen/infrastructure/adapters/out/repository/sede-almacen.repository.ts
   ============================================ */
...
export class SedeAlmacenRepository implements ISedeAlmacenRepositoryPort {
  ...
  async findBySedeId(id_sede: number): Promise<SedeAlmacen[]> {
    ...
    return records.map((record) => SedeAlmacenMapper.toDomainEntity(record));
  }
}
